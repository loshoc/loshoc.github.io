  ...
  const sideProjects = [
    {
      ...
      icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/string-extractor.png`,
      description: 'A Figma plugin for extracting UI strings.'
    },
    {
      name: 'Harman/Catdon',
      link: '/harman-catdon',
      icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/harman-catdon.png`,
      description: 'An innovative audio visualization project using AI technologies.'
    },
    {
      name: 'Mixed Text Style',
      link: '/mixed-text-style',
      icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/mixed.png`,
      description: 'A Figma plugin for custom fonts style in mixed-language text.'
    },
    {
      name: 'Haptic Hub',
      link: '/haptichub',
      icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/haptic-hub.png`,
      description: 'An iOS app for haptic feedback experiences.'
    },
  ];

  const apps = [
    { name: 'JBL One', link: '/jbl-one', type: 'internal', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/jbl-one.png` },
    { name: 'JBL Headphones', link: '/jbl-headphones', type: 'internal', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/jbl-headphones.png` },
    { name: 'AKG Headphones', link: '/akg-headphones', type: 'internal', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/akg-headphones.png` },
    { name: 'Linfo', link: '/linfo', type: 'internal', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/linfo.png` },
    { name: 'Side Projects', link: '#', type: 'internal', icon: `${process.env.PUBLIC_URL}/icons/side-projects.png` },
    { name: 'LinkedIn', link: 'https://www.linkedin.com/in/kiwi-guo/', type: 'external', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/linkedin.png` },
    { name: 'GitHub', link: 'https://github.com/loshoc', type: 'external', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/github.png` },
    { name: 'Email', link: 'mailto:loshochung@gmail.com', type: 'external', icon: `https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/email.png` },
  ];
                      ...
                      >
                        {app.name === 'Side Projects' ? (
                          <div className="side-projects-icon">
                            <img src={`https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/string-extractor.png`} alt="String Extractor" className="mini-icon" />
                            <img src={`https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/harman-catdon.png`} alt="Harman/Catdon" className="mini-icon" />
                            <img src={`https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/mixed.png`} alt="Mixed Text Style" className="mini-icon" />
                            <img src={`https://cdn.jsdelivr.net/gh/loshoc/webimg@master/img/haptic-hub.png`} alt="Haptic Hub" className="mini-icon" />
                          </div>
                        ) : (
